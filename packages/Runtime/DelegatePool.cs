...
{
    public static class DelegatePool<T>
        where T : MulticastDelegate
    {
        ...
        {
            object targetObj = StructOnlyBoxingPool<TTarget>.Get(target);
            Get(targetObj, pFunc, out result);
            var returner = DelegatePoolUtils.GetStructOnlyBoxingPoolReturner<TTarget>();

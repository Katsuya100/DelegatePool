...
{
    public static class ThreadStaticDelegatePool<T>
        where T : MulticastDelegate
    {
        ...
        {
            object targetObj = ThreadStaticStructOnlyBoxingPool<TTarget>.Get(target);
            Get(targetObj, pFunc, out result);
            var returner = DelegatePoolUtils.GetThreadStaticStructOnlyBoxingPoolReturner<TTarget>();
